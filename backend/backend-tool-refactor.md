Refactor @backend/ai_generator.py to support sequential tool calling where Cladue can make up to 2 tool calls in separate API rounds.
...
Use two parallel subagents to brainstorm possible plans. Do not implemenet any code